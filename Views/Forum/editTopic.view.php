            ...
            <form action="" method="post">
                ...
                <div class="grid gap-6 mb-4 md:grid-cols-2 mt-4">
                    <div>
                        ...
                        <input name="name" id="title" type="text" class="input-focus text-sm rounded-lg block w-full p-2.5" placeholder="Titre du topic" required value="<?= $topic->getName() ?>"></div>
                    <div>
                        <label for="last_name" class="block mb-2 text-sm font-medium">Tags : <small>Séparez vos tags par ','</small></label>
                        <input name="tags" type="text" id="last_name" class="input-focus text-sm rounded-lg block w-full p-2.5" placeholder="Tag1,Tag2,Tag3" value="<?php foreach ($topic->getTags() as $tag) {echo "" . $tag->getContent() . ",";} ?>">
                    </div>
                </div>
