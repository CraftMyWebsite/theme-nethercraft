            ...
            <form action="" method="post">
                        ...
                        <div class="flex ml-3 space-x-4">
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input name="important" value="1" id="important" type="checkbox" class="input-focus  w-4 h-4 rounded" >
                                </div>
                            ...
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input name="pin" id="pin" type="checkbox" value="" class="input-focus w-4 h-4 rounded" >
                                </div>
                                <label for="pin" class="ml-2 text-sm font-medium"><i style='color: <?= $iconPinColor?>' class="<?= $iconPin ?> fa-sm"></i> Épingler</label>
                            </div>
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input name="disallow_replies" value="1" id="closed" type="checkbox" class="input-focus w-4 h-4 rounded " >
                                </div>
                ...
                <div class="grid gap-6 mb-4 md:grid-cols-2 mt-4">
                    <div>
                        ...
                        <input name="name" id="title" type="text" class="input-focus text-sm rounded-lg block w-full p-2.5" placeholder="Titre du topic" required></div>
                    <div>
                        <label for="last_name" class="block mb-2 text-sm font-medium">Tags : <small>Séparez vos tags par ','</small></label>
                        <input name="tags" type="text" id="last_name" class="input-focus text-sm rounded-lg block w-full p-2.5" placeholder="Tag1,Tag2,Tag3">
                    </div>
                </div>
                ...
                <div class="flex mb-4 ">
                    <div class="flex ml-3 space-x-4">
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input id="follow" type="checkbox" name="followTopic" class="input-focus w-4 h-4 rounded" checked>
                            </div>
                ...
                <div class="text-center mt-4">
                    <button type="submit" data-cmw-style="background:global:main_color" class="head-button font-medium rounded px-4 py-2 md:px-5 md:py-2.5 mr-1 md:mr-2"><i class="fa-solid fa-pen-to-square"></i> Poster</button>
                </div>
            </form>
        </div>
    </section>
