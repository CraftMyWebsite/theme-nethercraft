                    ...
                    <form class="lg:space-y-6 mt-4" action="profile/update" method="post">
                        ...
                        <div class="md:grid md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="email" name="email" id="email" class="input-focus border border-gray-300  text-sm rounded-lg block w-full p-2.5" value="<?= $user->getMail() ?>" required>
                            </div>
                            <div>
                                <label for="email" class="block mb-2 text-sm font-medium">Pseudo minecraft</label>
                                <input type="text" name="pseudo" id="pseudo" class="input-focus border border-gray-300 text-sm rounded-lg block w-full p-2.5" value="<?= $user->getPseudo() ?>" required>
                            </div>
                        </div>
                        <div class="md:grid md:grid-cols-2 gap-4">
                            <div>
                                <label for="password" class="block mb-2 text-sm font-medium ">Mot de passe</label>
                                <input type="password" name="password" id="password" placeholder="********" class="input-focus bg-gray-50 border border-gray-300  text-sm rounded-lg block w-full p-2.5" required>
                            </div>
                            <div>
                                <label for="password" class="block mb-2 text-sm font-medium ">Confirmation</label>
                                <input type="password" name="passwordVerif" id="passwordVerif" placeholder="********" class="input-focus bg-gray-50 border border-gray-300  text-sm rounded-lg block w-full p-2.5" required>
                            </div>
                        </div>
                        <div class="pt-4">
